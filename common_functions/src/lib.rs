...
pub fn generate_unit_depiction_svg(mut counter_file: &std::fs::File, root_path: &String, filename: &String, note: &String, svg_transform: &String, front: bool, name: &String, colors: &Colors) {
	if INCLUDE_IMAGES {
		let path_prefix = "svg/";
...
pub fn generate_header_svg(program_name: &'static str, mut counter_file: &std::fs::File, note_number: &String, name: &String, comment: &String, version: &String) {
